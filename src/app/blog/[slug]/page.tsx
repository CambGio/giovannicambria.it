...
export default async function ArticoloPage({
  ...
  return (
    <article>
      {/* ── Banda-titolo bosco, più snella della hero delle altre
          pagine: qui la protagonista resta la lettura, non il titolo
          (spec DESIGN.md, lane "Bosco committed") ── */}
      <header className="bg-bosco">
        <div className="mx-auto max-w-[1280px] px-6 py-14 md:px-16 md:py-20">
          <div className="mx-auto max-w-[680px]">
            <Link
              href="/blog"
              className="font-mono text-[11px] uppercase tracking-[0.06em] text-carta/80 transition-colors hover:text-carta"
            >
              ← Tutti gli articoli
            </Link>
            <div className="mt-7">
              <Link
                ...
                className="font-mono text-[11px] uppercase tracking-[0.12em] text-carta/80 transition-colors hover:text-carta"
              >
                {frontmatter.rubricaLabel}
              </Link>
            </div>
            <h1 className="mt-4 max-w-[680px] text-titolo font-black text-carta">
              {frontmatter.titolo}
            </h1>
            {frontmatter.sommario && (
              <p className="mt-4 text-sottotitolo font-light text-carta/80">
                {frontmatter.sommario}
              </p>
            )}
            <div className="mt-5 font-mono text-[11px] uppercase tracking-[0.06em] text-carta/80 tabular-nums">
      ...
      {/* ── Corpo su carta intonso: la lettura resta su carta ── */}
      <div className="mx-auto max-w-[1280px] px-6 py-14 md:px-16 md:py-20">
        <div className="mx-auto max-w-[680px]">
