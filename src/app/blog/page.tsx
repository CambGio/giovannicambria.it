    ...
    <>
      <section className="mx-auto max-w-[1280px] px-6 py-16 md:px-16 md:py-24 lg:py-32">
        <div className="mb-7 flex items-center gap-3.5 font-mono text-[12px] uppercase tracking-[0.18em] font-medium">
          ...
          <span className="text-bosco">№ 01</span>
          <span className="text-grigio">Il blog</span>
        </div>

        <h1 className="max-w-[920px] text-display font-extrabold text-inchiostro">
        ...
        <div className="mt-14 border-t-2 border-inchiostro pt-7">
